...
public sealed class IpcCallerHeels : IIpcCaller
{
    ...
    public IpcCallerHeels(ILogger<IpcCallerHeels> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, StellarMediator stellarMediator)
    {
        _logger = logger;
    ...
    {
        _stellarMediator.Publish(new HeelsOffsetMessage());
    }
