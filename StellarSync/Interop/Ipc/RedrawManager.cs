...
public class RedrawManager
{
    ...
    public RedrawManager(StellarMediator stellarMediator, DalamudUtilService dalamudUtil)
    {
    ...
    {
        _stellarMediator.Publish(new PenumbraStartRedrawMessage(handler.Address));
        ...
        finally
        {
            ...
            _stellarMediator.Publish(new PenumbraEndRedrawMessage(handler.Address));
        }
    }
