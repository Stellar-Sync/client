...
public sealed class DalamudLoggingProvider : ILoggerProvider
{
    ...
    public DalamudLoggingProvider(StellarConfigService StellarConfigService, IPluginLog pluginLog, bool hasModifiedGameFiles)
    {
    ...
    public ILogger CreateLogger(string categoryName)
    {
        ...
        return _loggers.GetOrAdd(catName, name => new DalamudLogger(name, _StellarConfigService, _pluginLog, _hasModifiedGameFiles));
    }
