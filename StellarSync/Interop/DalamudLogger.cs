...
internal sealed class DalamudLogger : ILogger
{
    ...
    public DalamudLogger(string name, StellarConfigService StellarConfigService, IPluginLog pluginLog, bool hasModifiedGameFiles)
    {
        _name = name;
    ...
    {
        return (int)_StellarConfigService.Current.LogLevel <= (int)logLevel;
    }
