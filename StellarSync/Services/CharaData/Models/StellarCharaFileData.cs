...
public record StellarCharaFileData
{
    ...
    public StellarCharaFileData() { }
    public StellarCharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static StellarCharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<StellarCharaFileData>(Encoding.UTF8.GetString(data))!;
    }
