...
public sealed partial class CharaDataManager : DisposableMediatorSubscriberBase
{
    ...
    public CharaDataManager(ILogger<CharaDataManager> logger, ApiController apiController,
        ...
        StellarMediator stellarMediator, IpcManager ipcManager, DalamudUtilService dalamudUtilService,
        ...
        CharaDataCharacterHandler charaDataCharacterHandler, PairManager pairManager) : base(logger, stellarMediator)
    {
        ...
        stellarMediator.Subscribe<ConnectedMessage>(this, (msg) =>
        {
            _connectCts?.Cancel();
            _connectCts?.Dispose();
            _connectCts = new();
        ...
        stellarMediator.Subscribe<DisconnectedMessage>(this, (msg) =>
        {
            _ownCharaData.Clear();
            _metaInfoCache.Clear();
            _sharedWithYouData.Clear();
    ...
    public Task<(StellarCharaFileHeader LoadedFile, long ExpectedLength)>? LoadedMcdfHeader { get; private set; }
    ...
    public void SaveStellarCharaFile(string description, string filePath)
    {
