...
public sealed class StellarMediator : IHostedService
{
    ...
    public StellarMediator(ILogger<StellarMediator> logger, PerformanceCollectorService performanceCollector, StellarConfigService stellarConfigService)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Starting StellarMediator");
        ...
        _logger.LogInformation("Started StellarMediator");
