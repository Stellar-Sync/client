...
public sealed class DtrEntry : IDisposable, IHostedService
{
    ...
    private readonly ConfigurationServiceBase<StellarConfig> _configService;
    ...
    public DtrEntry(ILogger<DtrEntry> logger, IDtrBar dtrBar, ConfigurationServiceBase<StellarConfig> configService, StellarMediator stellarMediator, PairManager pairManager, ApiController apiController)
    {
        _logger = logger;
        _dtrBar = dtrBar;
    ...
    private IDtrBarEntry CreateEntry()
    {
        ...
        entry.OnClick = _ => _stellarMediator.Publish(new UiToggleMessage(typeof(CompactUi)));
