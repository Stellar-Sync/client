...
public class EditProfileUi : WindowMediatorSubscriberBase
{
    ...
    public EditProfileUi(ILogger<EditProfileUi> logger, StellarMediator mediator,
    ...
    protected override void DrawInternal()
    {
        ...
        var profile = _stellarProfileManager.GetStellarProfile(new UserData(_apiController.UID));
        ...
        ImGui.TextWrapped($"- All users that are paired and unpaused with you will be able to see your profile picture and description.{Environment.NewLine}" +
            ...
            $"- In case of valid reports from other users this can lead to disabling your profile forever or terminating your Stellar account indefinitely.{Environment.NewLine}" +
