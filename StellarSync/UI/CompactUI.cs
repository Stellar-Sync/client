...
public class CompactUi : WindowMediatorSubscriberBase
{
    ...
    public CompactUi(ILogger<CompactUi> logger, UiSharedService uiShared, StellarConfigService configService, ApiController apiController, PairManager pairManager,
        ServerConfigurationManager serverManager, StellarMediator mediator, FileUploadManager fileTransferManager,
        TagHandler tagHandler, DrawEntityFactory drawEntityFactory, SelectTagForPairUi selectTagForPairUi, SelectPairForTagUi selectPairForTagUi,
        PerformanceCollectorService performanceCollectorService, IpcManager ipcManager)
        : base(logger, mediator, "###StellarSyncMainUI", performanceCollectorService)
    {
        ...
        TitleBarButtons = new()
        {
            new TitleBarButton()
            {
                ...
                {
                    ImGui.BeginTooltip();
                    ImGui.Text("Open Stellar Settings");
                    ImGui.EndTooltip();
                }
            },
            new TitleBarButton()
            {
                ...
                {
                    ImGui.BeginTooltip();
                    ImGui.Text("Open Stellar Event Viewer");
                    ImGui.EndTooltip();
                }
            }
        };
    ...
    protected override void DrawInternal()
    {
        ...
        if (!_ipcManager.Initialized)
        {
            ...
            UiSharedService.ColorTextWrapped($"One or more Plugins essential for Stellar operation are unavailable. Enable or update following plugins:", ImGuiColors.DalamudRed);
    ...
    private string GetServerError()
    {
        return _apiController.ServerState switch
        {
            ...
            ServerState.NoAutoLogon => "This character has automatic login into Stellar disabled. Press the connect button to connect to Stellar.",
            _ => string.Empty
        };
    }
