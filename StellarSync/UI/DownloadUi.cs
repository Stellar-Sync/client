...
public class DownloadUi : WindowMediatorSubscriberBase
{
    ...
    public DownloadUi(ILogger<DownloadUi> logger, DalamudUtilService dalamudUtilService, StellarConfigService configService,
        FileUploadManager fileTransferManager, StellarMediator mediator, UiSharedService uiShared, PerformanceCollectorService performanceCollectorService)
