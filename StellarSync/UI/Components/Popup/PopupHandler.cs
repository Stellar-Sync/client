...
public class PopupHandler : WindowMediatorSubscriberBase
{
    ...
    public PopupHandler(ILogger<PopupHandler> logger, StellarMediator mediator, IEnumerable<IPopupHandler> popupHandlers,
        PerformanceCollectorService performanceCollectorService, UiSharedService uiSharedService)
        : base(logger, mediator, "StellarPopupHandler", performanceCollectorService)
    {
