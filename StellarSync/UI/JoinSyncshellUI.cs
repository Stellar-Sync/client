...
internal class JoinSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public JoinSyncshellUI(ILogger<JoinSyncshellUI> logger, StellarMediator mediator,
        UiSharedService uiSharedService, ApiController apiController, PerformanceCollectorService performanceCollectorService) 
        : base(logger, mediator, "Join existing Syncshell###StellarSyncJoinSyncshell", performanceCollectorService)
    {
