...
public class StandaloneProfileUi : WindowMediatorSubscriberBase
{
    ...
    public StandaloneProfileUi(ILogger<StandaloneProfileUi> logger, StellarMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, StellarProfileManager stellarProfileManager, PairManager pairManager, Pair pair,
        PerformanceCollectorService performanceCollector)
        : base(logger, mediator, "Stellar Profile of " + pair.UserData.AliasOrUID + "##StellarSyncStandaloneProfileUI" + pair.UserData.AliasOrUID, performanceCollector)
    {
    ...
    protected override void DrawInternal()
    {
        try
        {
            ...
            var stellarProfile = _stellarProfileManager.GetStellarProfile(Pair.UserData);
            ...
            ImGui.SameLine();
            var descriptionTextSize = ImGui.CalcTextSize(stellarProfile.Description, wrapWidth: 256f);
            ...
            if (ImGui.BeginChildFrame(1000, childFrame))
            {
                ...
                ImGui.TextWrapped(stellarProfile.Description);
            }
            ImGui.EndChildFrame();
