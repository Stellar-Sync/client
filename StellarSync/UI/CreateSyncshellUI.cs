...
public class CreateSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public CreateSyncshellUI(ILogger<CreateSyncshellUI> logger, StellarMediator stellarMediator, ApiController apiController, UiSharedService uiSharedService,
        PerformanceCollectorService performanceCollectorService)
        : base(logger, stellarMediator, "Create new Syncshell###StellarSyncCreateSyncshell", performanceCollectorService)
    {
    ...
    protected override void DrawInternal()
    {
        ...
        if (_lastCreatedGroup == null)
        {
            ...
            UiSharedService.TextWrapped("(Those preferred permissions can be changed anytime after Syncshell creation, your defaults can be changed anytime in the Stellar Settings)");
        }
        else
        {
