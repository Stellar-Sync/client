...
{
    public const string CustomAllTag = "Stellar_All";
    public const string CustomOfflineTag = "Stellar_Offline";
    public const string CustomOfflineSyncshellTag = "Stellar_OfflineSyncshell";
    public const string CustomOnlineTag = "Stellar_Online";
    public const string CustomUnpairedTag = "Stellar_Unpaired";
    public const string CustomVisibleTag = "Stellar_Visible";
