...
internal sealed partial class CharaDataHubUi : WindowMediatorSubscriberBase
{
    ...
    public CharaDataHubUi(ILogger<CharaDataHubUi> logger, StellarMediator mediator, PerformanceCollectorService performanceCollectorService,
        ...
        : base(logger, mediator, "Stellar Sync Character Data Hub###StellarSyncCharaDataUI", performanceCollectorService)
    {
        ...
        Mediator.Subscribe<GposeStartMessage>(this, (_) => IsOpen |= _configService.Current.OpenStellarHubOnGposeStart);
    ...
    {
        _uiSharedService.BigText("Stellar Character Data File Export");

        DrawHelpFoldout("This feature allows you to pack your character into a MCDF file and manually send it to other people. MCDF files can officially only be imported during GPose through Stellar. " +
        ...
        if (_readExport)
        {
            ...
            if (_uiSharedService.IconTextButton(FontAwesomeIcon.Save, "Export Character as MCDF"))
            {
                ...
                _uiSharedService.FileDialogManager.SaveFileDialog("Export Character to file", ".mcdf", defaultFileName, ".mcdf", (success, path) =>
                {
                    ...
                    _charaDataManager.SaveStellarCharaFile(_exportDescription, path);
    ...
    private void DrawSettings()
    {
        ...
        ImGuiHelpers.ScaledDummy(5);
        bool openInGpose = _configService.Current.OpenStellarHubOnGposeStart;
        if (ImGui.Checkbox("Open Character Data Hub when GPose loads", ref openInGpose))
        {
            _configService.Current.OpenStellarHubOnGposeStart = openInGpose;
            _configService.Save();
        }
        _uiSharedService.DrawHelpText("This will automatically open the import menu when loading into Gpose. If unchecked you can open the menu manually with /stellar gpose");
